...
class App extends React.Component {
  ...
  _handleLeave = async () => {
    ...
    confirm({
      title: 'Leave Now?',
      content: 'ON want to leave the room?',
      okButtonProps:{style:{borderColor:"black", color:getContrastYIQ(process.env.NEXT_PUBLIC_SECONDARY_COLOR)?"black":"white"}},
      async onOk() {
    ...
    return (
      <Layout className="app-layout">
        <Header
          ...
          style={{
            backgroundColor:  process.env.NEXT_PUBLIC_BACKGROUND_COLOR||'#0B0F15',
            zIndex: '10',
            padding: '0 0',
            margin: '0 auto',
            width: '100%',
          ...
          {login ? (
            <Layout className="app-content-layout">
              <Sider
                ...
                style={{ backgroundColor: process.env.NEXT_PUBLIC_BACKGROUND_COLOR|| '#0B0F15' }}
              >
